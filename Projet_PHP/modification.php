...
$post = ['id_stagiaires' => '', 'nom' => '', 'prenom' => '','cin' => '', 'age' => '', 'email' => '','pwd' => '', 'adress' => '','sexe' => '', 'tele' => ''];
...
<body class="bg-gray-200">
    ...
    <form action="modifier.php" method="POST">
        ...
        <input class="title bg-gray-100 border border-gray-300 p-2 mb-4 outline-none" spellcheck="false" placeholder="id_stagiaires" type="number" name="id_stagiaires" value="<?php echo $post['id_stagiaires']; ?>">
            <input class="title bg-gray-100 border border-gray-300 p-2 mb-4 outline-none" placeholder="nom" type="text" name="nom" value="<?php echo $post['nom']; ?>">
            ...
            <input class="title bg-gray-100 border border-gray-300 p-2 mb-4 outline-none" spellcheck="false" placeholder="sexe" type="text" name="sexe" value="<?php echo $post['sexe']; ?>">
